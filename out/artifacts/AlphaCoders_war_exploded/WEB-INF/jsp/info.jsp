...
<c:forEach items="${tweets}" var="item">
    <font color="black" size="3"> ${item}</font><br>
</c:forEach>
...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="all href="<c:url value="file1/default.css" />" />
    <link rel="stylesheet" type="text/css" media="all href="<c:url value="file1/fonts.css" />" />
...
<div id="page" class="container">
    <div id="header">
        <div id="logo">
            <h1><a href="#">Alpha Coders</a></h1>
        </div>
        <div id="menu">
            <ul height: 100% position: fixed overflow: auto;>
                <li class="current_page_item"><a href="#" accesskey="1" title="">Search Results</a></li>
                <li><a href="" accesskey="2" title="">Analytics</a></li>
            </ul>
        </div>
    </div>
    <div id="main">
        <div id="banner">
            <img src="../../map.jpg" alt="" class="image-full" />
        </div>
        <div id="featured">
            <div class="title">
                <h2>${query}</h2>
